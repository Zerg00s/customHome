...
$BannerItemList = CreateList "BannerItem"

AddField $BannerItemList "ShortText" "Text"
AddRichHtmlField $BannerItemList "DetailedText" "TRUE"
AddField $BannerItemList "Picture" "URL"
...
$favoritesList = CreateList "Favorites" "GenericList"
AddField $favoritesList "Value" "Text"
